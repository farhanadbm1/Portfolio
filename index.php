      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>Farhana Jesmin</h4>
            <p><em>
              Under graduate student.very passionate for data scientist with the experience of competetive programmer and statistics.
            </em></p>
            <p>
            <ul>
              <li>Am bottola Jashore</li>
              <li>(123) 456-7891</li>
              <li>farhanajemsin18@gmail.com</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            ...
            <h5>2020 - 2024</h5>
            <p><em>Jashore Univerty of Science and Engineering</em></p>
            <p>Qui deserunt veniam. Et sed aliquam labore tempore sed quisquam iusto autem sit. Ea vero voluptatum qui ut dignissimos deleniti nerada porti sand markend</p>
          </div>
          <div class="resume-item">
            <h4>HSC</h4>
            <h5>2016 - 2018</h5>
            <p><em>Nawab Fayjunnesa Govt Collage,Comilla
            </em></p>
            <p>Quia nobis sequi est occaecati aut. Repudiandae et iusto quae reiciendis et quis Eius vel ratione eius unde vitae rerum voluptates asperiores voluptatem Earum molestiae consequatur neque etlon sader mart dila</p>
          </div>
        </div>
        <div class="col-lg-6">
          <h3 class="resume-title">Additional Quality</h3>
          <div class="resume-item">
            <h4>Team Leader</h4>
            <h5>2-2 project team leader</h5>
            <p><em>Image to text </em></p>
            <p>
            <ul>
              <li>Lead in the design, development, and implementation of the graphic, layout, and production communication materials</li>
              <li>Delegate tasks to the 7 members of the design team and provide counsel on all aspects of the project. </li>
              <li>Supervise the assessment of all graphic materials in order to ensure quality and accuracy of the design</li>
              <li>Oversee the efficient use of production project budgets ranging from $00 - $000</li>
            </ul>
            </p>
          </div>
          <div class="resume-item">
            <h4>competetive programmer</h4>
            <h5>2022 - 2023</h5>
            <p><em>I am continuing as a competetive programmer and practicing my code journey in leetcode, codeforces,hackerrank.i have solved more than 50 problem</em></p>
            <p>
            <ul>
              <li>Codeforce</li>
              <li>leetcode</li>
